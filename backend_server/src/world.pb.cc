...
static ::_pb::Metadata file_level_metadata_world_2eproto[13];
...
const char descriptor_table_protodef_world_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ldid\030\001 \001(\003\022\033\n\006trucks\030\002 \003(\0132\013.UInitTruck\022"
  ...
  "ckid\030\001 \002(\005\022$\n\010packages\030\002 \003(\0132\022.UDelivery"
